...
const Icons = {
  ...
  rust: <svg className="w-10 h-10" viewBox="0 0 100 100" fill="currentColor"><circle cx="50" cy="50" r="8"/><path d="M50 10c-5 0-9 4-9 9v15c-10 3-17 12-17 23h-9c-5 0-9 4-9 9s4 9 9 9h9c0 11 7 20 17 23v15c0 5 4 9 9 9s9-4 9-9V83c10-3 17-12 17-23h9c5 0 9-4 9-9s-4-9-9-9h-9c0-11-7-20-17-23V19c0-5-4-9-9-9z" opacity="0"/><path d="M50 5a6 6 0 00-6 6v20.1a25 25 0 00-13.9 8L15.5 30a6 6 0 00-8.5 8.5l14.6 9.1A25 25 0 0019 57H6a6 6 0 000 12h13a25 25 0 002.6 9.4L7 87.5a6 6 0 008.5 8.5l9.1-14.6a25 25 0 008 4.5V106a6 6 0 0012 0V85.9a25 25 0 008-4.5l9.1 14.6a6 6 0 008.5-8.5l-14.6-9.1A25 25 0 0058 69h13a6 6 0 000-12H58a25 25 0 00-2.6-9.4L70 38.5a6 6 0 00-8.5-8.5l-9.1 14.6a25 25 0 00-8-4.5V20a6 6 0 00-6-6z" opacity="0"/><g><path d="M42 20L30 38c5-4 12-6 20-6s15 2 20 6L58 20c-2-3-5-5-8-5s-6 2-8 5z"/><path d="M20 58l18-12c-4 5-6 12-6 20s2 15 6 20L20 68c-3-2-5-5-5-8s2-6 5-8z" transform="rotate(-120 50 50)"/><path d="M20 58l18-12c-4 5-6 12-6 20s2 15 6 20L20 68c-3-2-5-5-5-8s2-6 5-8z" transform="rotate(120 50 50)"/></g></svg>,
