...
const Icons = {
  ...
  rust: <svg className="w-8 h-8" viewBox="0 0 100 100" fill="white"><path d="M50 5 L40 35 L50 40 L60 35 Z"/><path d="M50 5 L40 35 L50 40 L60 35 Z" transform="rotate(120 50 50)"/><path d="M50 5 L40 35 L50 40 L60 35 Z" transform="rotate(240 50 50)"/><rect x="44" y="44" width="12" height="12" transform="rotate(45 50 50)"/></svg>,
