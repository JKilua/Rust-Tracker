...
const Icons = {
  ...
  rust: <svg className="w-10 h-10" viewBox="0 0 100 100" fill="currentColor"><circle cx="50" cy="50" r="6"/><path d="M50 8c-2.5 0-4.5 1-5.5 3L34 30c4.5-3 10-5 16-5s11.5 2 16 5L55.5 11c-1-2-3-3-5.5-3z"/><path d="M13 62c-1.3 2.2-1 4.5.5 6.5l18 12c-1.5-5-2-10.5-1-16s3.5-10.5 7-14.5L15.5 56c-2 1-3 3.5-2.5 6z"/><path d="M87 62c1.3 2.2 1 4.5-.5 6.5l-18 12c1.5-5 2-10.5 1-16s-3.5-10.5-7-14.5l22 6c2 1 3 3.5 2.5 6z"/></svg>,
