...
const Icons = {
  ...
  rust: <svg className="w-10 h-10" viewBox="0 0 100 100" fill="currentColor"><rect x="44" y="44" width="12" height="12" transform="rotate(45 50 50)"/><path d="M38 12h24l8 28H30z"/><path d="M12 52v-24l28 8v28z" transform="rotate(30 50 50)"/><path d="M88 52v-24l-28 8v28z" transform="rotate(-30 50 50)"/></svg>,
