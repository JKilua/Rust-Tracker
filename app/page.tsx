...
const Icons = {
  ...
  rust: <img src="https://community.cloudflare.steamstatic.com/public/images/apps/252490/rust_logo_small.png" alt="Rust" className="w-10 h-10" style={{filter: 'grayscale(100%) brightness(0.7)'}} />,
