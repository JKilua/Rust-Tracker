...
const Icons = {
  ...
  rust: <svg className="w-10 h-10" viewBox="0 0 100 100" fill="white"><path d="M35 10h30l10 25H25z"/><path d="M25 35h15v15H20z" transform="rotate(-60 50 50)"/><path d="M60 35h15v15H80z" transform="rotate(60 50 50)"/><rect x="42" y="42" width="16" height="16" transform="rotate(45 50 50)"/></svg>,
